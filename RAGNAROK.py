...
bot = telebot.TeleBot('7566686814:AAHubgflty9nbjri1JnZqONBk_rBKZlM01M')
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            if user_id in bgmi_cooldown:
                ...
                if time_since_last_attack < 900:
                    remaining_time = 900 - time_since_last_attack
